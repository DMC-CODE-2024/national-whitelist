...
public interface ActiveForeignImeiWithDifferentMsisdnRepository extends JpaRepository<ActiveForeignImeiWithDifferentMsisdn, Long>, JpaSpecificationExecutor<ActiveForeignImeiWithDifferentMsisdn> {
    ...
    Page<ActiveForeignImeiWithDifferentMsisdn> findAllLatestDifferentImeiInLastXDays(@Param("startDate") LocalDateTime paramLocalDateTime1, @Param("endDate") LocalDateTime paramLocalDateTime2, Pageable paramPageable);
